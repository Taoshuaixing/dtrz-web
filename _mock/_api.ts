...
const covers2 = [
  './assets/tmp/img/p1Large.jpg',
  './assets/tmp/img/p2Large.jpg',
  './assets/tmp/img/p3Large.jpg',
  './assets/tmp/img/p4Large.jpg',
  './assets/tmp/img/p5Large.jpg',
  './assets/tmp/img/p6Large.jpg',
  './assets/tmp/img/p7Large.jpg',
];
const covers = [
...
function getFakeList2(count: number = 20): any[] {
  const list: any[] = [];
  for (let i = 0; i < count; i += 1) {
    list.push({
      ...
      title: titles[i % 7],
      avatar: avatars[i % 7],
      cover: parseInt((i / 4).toString(), 10) % 2 === 0 ? covers2[i % 8] : covers2[3 - (i % 8)],
...
export const APIS = {
  '/api/zdrw-list': (req: MockRequest) => getZdrwList(),

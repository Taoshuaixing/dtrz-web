...
@Component({
  selector: 'app-yangben-option-stat-for-wenzi',
  templateUrl: './yangben-option-stat-for-wenzi.component.html',
  styles: [
  ]
})
export class YangbenOptionStatForWenziComponent implements OnInit {
  listOfAllData=[];
  loading: any;
  total =1;
  pageIndex =1;
  ...
  async ngOnInit() {
    ...
    if (this.aclService.data.roles.indexOf("dagl_editor") >= 0 ){
      // 文字岗
      this.wenziFlag = 1;
    } 

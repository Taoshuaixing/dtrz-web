...
@Component({
  selector: 'app-zhanghao-data-field-setting-post',
  templateUrl: './zhanghao-data-field-setting-post.component.html',
  styles: []
})
export class ZhanghaoDataFieldSettingPostComponent implements OnInit {
  ...
  async showModal() {
    ...
    const showItem = await this.zhanghaoService.getShowItem_post(this.postId);

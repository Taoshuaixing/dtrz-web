...
@Component({
  selector: 'app-zhanghao-template-post',
  templateUrl: './zhanghao-template-post.component.html',
  styleUrls: ['./zhanghao-template-post.component.css']
})
export class ZhanghaoTemplatePostComponent implements OnInit {
  ...
  constructor(private crudService: CrudService,
              ...
              public zahnghaoService:ZhanghaoService,
  ...
  async ngOnInit() {
    this.fieldList = await this.zahnghaoService.getAllField()
  ...
  async getTemplatePostList() {
    ...
    return new Promise((resolve, reject) => {
        this.crudService.searchAll(environment.baseUrl + 'api', 'zhanghao-template-post')
          .subscribe((res: any) => {
            res = res.map(m=> {
  ...
  del(placeId: any,postItem:any) {
    this.modalService.confirm({
      ...
      nzOkType: 'danger',
      nzOnOk: () => {
          this.crudService.add(environment.baseUrl + 'api', 'zhanghao-template-post/del', {placeId:placeId,postId:postItem.id}).subscribe((res:any) => {
